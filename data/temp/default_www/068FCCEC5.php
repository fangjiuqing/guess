...
<link rel="stylesheet" href="http://guess.d/template/mobile/lib/weui.min.css">
<link rel="stylesheet" href="http://guess.d/template/mobile/css/jquery-weui.css">
<link rel="stylesheet" href="http://guess.d/template/mobile/css/demos.css">
  ...
  <body ontouchstart>
    ...
    <script src="http://guess.d/template/mobile/lib/jquery-2.1.4.js"></script>
<script src="http://guess.d/template/mobile/lib/fastclick.js"></script>
<script>
  $(function() {
    FastClick.attach(document.body);
  });
</script>
<script src="http://guess.d/template/mobile/js/jquery-weui.js"></script>
