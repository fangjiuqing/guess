...
<head>
    ...
    <link href="http://guess.d/template/style/css/login.min.css" rel="stylesheet">
    <style type="text/css" media="screen">
        body.signin{
            height:auto;
            background:url(http://guess.d/template/style/img/bg1.jpg);
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                <form method="post" id="login-form" action="<?php echo(RGX\router::url('login')); ?>" autocomplete="off">
                    <h4 class="no-margins">Angel系统</h4>
...
<script src="http://guess.d/template/style/js/content.min.js?v=1.0.0"></script>
...
<script src="http://guess.d/template/style/js/common.js"></script>
<script src="http://guess.d/template/style/js/plugins/datapicker/bootstrap-datepicker.js"></script>
