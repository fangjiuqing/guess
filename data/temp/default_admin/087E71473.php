            ...
            <li class="nav-header" style="text-align: center">
                <div class="dropdown profile-element">
                    <a href="javascript:;" data-href="<?php echo(RGX\router::url('account-add-id-%d' , $login['admin_id'])); ?>">
                        <span class="clear">
                           <span class="block m-t-xs"><strong class="font-bold" style="font-size: 14px;">公众号竞猜管理平台</strong></span>
...
<!--右侧部分开始-->
        <div id="page-wrapper" class="gray-bg dashbard-1" style="margin-left:190px;">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo(RGX\router::url('timu-index')); ?>" frameborder="0" data-id="index_home" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
    <script src="https://www.dadiandesign.com/wx/guess/admin/template/style/js/jquery.min.js?v=2.1.4"></script>
    <script src="https://www.dadiandesign.com/wx/guess/admin/template/style/js/bootstrap.min.js?v=3.3.6"></script>
    <script src="https://www.dadiandesign.com/wx/guess/admin/template/style/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="https://www.dadiandesign.com/wx/guess/admin/template/style/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="https://www.dadiandesign.com/wx/guess/admin/template/style/js/plugins/layer/layer.min.js"></script>
    <script src="https://www.dadiandesign.com/wx/guess/admin/template/style/js/hplus.min.js?v=4.1.0"></script>
    <script src="https://www.dadiandesign.com/wx/guess/admin/template/style/js/contabs.min.js"></script>
    <script src="https://www.dadiandesign.com/wx/guess/admin/template/style/js/plugins/pace/pace.min.js"></script>
