...
<head>
    ...
    <link href="http://newcaifu.d/template/default/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
    <link href="http://newcaifu.d/static/font-awesome/css/font-awesome.css?v=4.7.0" rel="stylesheet">
    <link href="http://newcaifu.d/template/default/css/animate.min.css" rel="stylesheet">
    <link href="http://newcaifu.d/template/default/css/style.min862f.css?v=4.1.0" rel="stylesheet">
    <link href="http://newcaifu.d/template/default/css/bids.css?v=1.0.0" rel="stylesheet">
    ...
    <link href="http://newcaifu.d/template/default/css/login.min.css" rel="stylesheet">
    <style type="text/css" media="screen">
        body.signin{
            height:auto;
            background:url(http://newcaifu.d/template/default/img/bg2.jpg) no-repeat center fixed;
...
<script src="http://newcaifu.d/template/default/js/bootstrap.min.js?v=3.3.6"></script>
<script src="http://newcaifu.d/template/default/js/content.min.js?v=1.0.0"></script>
...
<script src="http://newcaifu.d/template/default/js/common.js"></script>
<script src="http://newcaifu.d/template/default/js/plugins/datapicker/bootstrap-datepicker.js"></script>
