            ...
            <div class="col-sm-12">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <!--filter start-->
                        <input type="hidden" data-key="m" value="<?php echo($filter['m'] ? : 1);?>">
                        ...
                        <div class="row row-margin-top text-center">
                            <div class="col-md-12">
                                <a href="javascript:;" class="btn btn-xs btn-primary pull-right" data-url="projects-history-m-1" id="search-btn" style="margin-top:5px;margin-right: 15px;" id="filter_sbtn">
                        ...
                        <table class="table table-striped table-hover dataTables">
                            <thead>
                                ...
                                <th class="center" width="10%">报送主体</th>
                                <th class="center" width="6%">申报日期</th>
                                <th class="center" width="6%">当前状态</th>
                                <th class="center" width="8%">主管部门/地区</th>
                                <th class="center" width="8%">总投资额（万）</th>
                                <th class="center" width="6%">申请金额</th>
                                <th class="center" width="5%">负责人</th>
                                ...
                                <td>
                                    <a href="<?php echo(RGX\router::url('projects-add-id-%d' , $v['pro_id'])); ?>"> <?php echo(RGX\misc::cutstr($v['pro_title'], 18));?> <?php if (strlen($v['pro_title']) > 56):?>..<?php endif;?></a>
                                </td>
                                <td class="project-title"> <?php echo(RGX\misc::cutstr($v['apply_gov_name'], 12));?> </td>
                                <td class="project-title"> <?php echo(date('Y-m-d' , $v['apply_date']));?> </td>
                                <td class="project-title"> <?php echo($status[$v['apply_status']]);?> </td>
                                <td class="center"> <?php echo($v['pro_region1'] ? : '-');?> </td>
                                <td class="center text-warning"> <?php echo($v['pro_investment'] ? : '-');?> </td>
                                <td class="center"> <?php echo($v['pro_apply_inves']);?> </td>
                                <td class="center"> <?php echo($v['pro_contacter'] ? : '-');?> </td>
                                <td class="center">
                                    <a href="#" data-href="<?php echo(RGX\router::url('@%s-back-id-%d' , $_MODULE , $v['pro_id'])); ?>" class="btn btn-warning btn-xs radius-small" title="查看">撤</a>
                                    <a href="<?php echo(RGX\router::url('@%s-add-id-%d' , $_MODULE , $v['pro_id'])); ?>" class="btn btn-success btn-xs radius-small" title="查看">改</a>
                                    <a href="#" data-href="<?php echo(RGX\router::url('@%s-del-id-%d' , $_MODULE , $v['pro_id'])); ?>" class="btn btn-danger btn-xs radius-small" title="查看">删</a>
                                </td>
