            ...
            <div class="col-sm-12">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>
                            <i class="fa fa-list text-success"></i> 专家列表
                        </h5>
                    </div>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row row-margin-top text-center hide">
                            <div class="col-md-12">
                        ...
                        <table class="table table-striped table-hover dataTables">
                            <thead>
                                <th class="center" width="10%">专家姓名</th>
                                <th class="center" width="8%">电话</th>
                                <th class="center" width="14%">单位</th>
                                <th class="center" width="10%">职务</th>
                                <th class="center" width="15%">标签</th>
                                <th class="center" width="5%">操作</th>
                            </thead> <?php if (empty($list)):?> <tr>
                                <table class="table table-striped dataTables">
                                    <tr><td>暂无记录</td></tr>
                                </table>
                            </tr> <?php endif;?><tbody> <?php unset($k, $v); $k_index = 0; foreach ((array)$list as $k => $v): $k_index ++;?> <tr class="center" id="item-<?php echo($v['expert_id']);?>">
                                <td> <?php echo($v['expert_name']);?> </td>
                                <td class="project-title"> <?php echo($v['expert_mobile']);?> </td>
                                <td class="center"> <?php echo($v['expert_org_title'] ? : '-');?> </td>
                                <td class="center"> <?php echo($v['expert_title'] ? : '-');?> </td>
                                <td class="center"> <?php echo($v['expert_tags'] ? : '-');?> </td>
