            ...
            <li class="nav-header" style="text-align: center">
                <div class="dropdown profile-element">
                    <a href="javascript:;" data-href="<?php echo(RGX\router::url('account-add-id-%d' , $login['admin_id'])); ?>">
                        <span class="clear">
                           <span class="block m-t-xs"><strong class="font-bold" style="font-size: 14px;">材富网会员管理系统</strong></span>
...
<!--右侧部分开始-->
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#"> <?php echo($login['user_company_name']);?> </a>
                        </li>
                        <li class="dropdown">
                            <a aria-expanded="false" role="button" href="#" class="dropdown-toggle" data-toggle="dropdown"> 
                                <i class="fa fa-user"></i> <?php echo($login['user_name']);?> (<?php echo($login['user_identi_label']);?>)<span class="caret"></span></a>
    ...
    <script src="http://newcaifu.d/template/style/js/jquery.min.js?v=2.1.4"></script>
    <script src="http://newcaifu.d/template/style/js/bootstrap.min.js?v=3.3.6"></script>
    <script src="http://newcaifu.d/template/style/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="http://newcaifu.d/template/style/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="http://newcaifu.d/template/style/js/plugins/layer/layer.min.js"></script>
    <script src="http://newcaifu.d/template/style/js/hplus.min.js?v=4.1.0"></script>
    <script src="http://newcaifu.d/template/style/js/contabs.min.js"></script>
    <script src="http://newcaifu.d/template/style/js/plugins/pace/pace.min.js"></script>
