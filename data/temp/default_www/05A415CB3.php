...
<head>
    ...
    <link href="http://guess.d/template/style/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
    <link href="http://guess.d/static/font-awesome/css/font-awesome.css?v=4.7.0" rel="stylesheet">
    <link href="http://guess.d/template/style/css/animate.min.css" rel="stylesheet">
    <link href="http://guess.d/template/style/css/style.min862f.css?v=4.1.0" rel="stylesheet">
    <link href="http://guess.d/template/style/css/bids.css?v=1.0.0" rel="stylesheet">
    <script type="text/javascript">
        var upload_image_url = '<?php echo(RGX\router::url('@upload-image')); ?>',
            DATA_URL    = 'http://guess.d/data/',
            STATIC_URL  = 'http://guess.d/static/',
            UPLOAD_URL  = 'http://guess.d/data/attachment/',
            ...
            <li class="nav-header" style="text-align: center">
                <div class="dropdown profile-element">
                    <a href="javascript:;" data-href="<?php echo(RGX\router::url('account-add-id-%d' , $login['admin_id'])); ?>">
                        <span class="clear">
                           <span class="block m-t-xs"><strong class="font-bold" style="font-size: 14px;">Guess</strong></span>
...
<!--右侧部分开始-->
    ...
    <script src="http://guess.d/template/style/js/jquery.min.js?v=2.1.4"></script>
    <script src="http://guess.d/template/style/js/bootstrap.min.js?v=3.3.6"></script>
    <script src="http://guess.d/template/style/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="http://guess.d/template/style/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="http://guess.d/template/style/js/plugins/layer/layer.min.js"></script>
    <script src="http://guess.d/template/style/js/hplus.min.js?v=4.1.0"></script>
    <script src="http://guess.d/template/style/js/contabs.min.js"></script>
    <script src="http://guess.d/template/style/js/plugins/pace/pace.min.js"></script>
