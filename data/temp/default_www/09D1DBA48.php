...
<link rel="stylesheet" href="http://angel.d/template/style/css/plugins/datapicker/datepicker3.css">
</head>
<body class="gray-bg">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row row-margin-top">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control label-opt" data-key="keyword" placeholder="公司名称" value="<?php echo($filter['keyword']);?>">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row row-margin-top text-center">
                            <div class="col-md-12">
                                <a href="javascript:;" class="btn btn-xs btn-primary pull-right" data-url="company-index" id="search-btn" style="margin-top:5px;margin-right: 15px;" id="filter_sbtn">
                                    <i class="fa fa-search"></i> 搜 索
                                </a>

                                <a href="<?php echo(RGX\router::url('company-index')); ?>" class="btn btn-xs btn-warning pull-right" style="margin-top:5px;margin-right: 15px;">
                        ...
                        <table class="table table-striped table-hover dataTables">
                            <thead>
                                <th class="center" width="22%">企业名称</th>
                                <th class="center" width="10%">联系人</th>
                                <th class="center" width="8%">联系电话</th>
                                <th class="center" width="8%">成立日期</th>
                                <th class="center" width="24%">标签</th>
                                <th class="center" width="5%">操作</th>
                            </thead> <?php if (empty($list)):?> <tr>
                                <table class="table table-striped dataTables">
                                    <tr><td>暂无记录</td></tr>
                                </table>
                            </tr> <?php endif;?><tbody> <?php unset($k, $v); $k_index = 0; foreach ((array)$list as $k => $v): $k_index ++;?> <tr class="center" id="item-<?php echo($v['comp_id']);?>">
                                <td>
                                    <a href="<?php echo(RGX\router::url('company-add-id-%d' , $v['comp_id'])); ?>"> <?php echo(RGX\misc::cutstr($v['comp_title'], 28));?> <?php if (strlen($v['comp_title']) > 84):?>..<?php endif;?></a>
                                </td>
                                <td class="project-title"> <?php echo(RGX\misc::cutstr($v['comp_contacter'], 18));?> </td>
                                <td class="center"> <?php echo($v['comp_phone'] ? : '-');?> </td>
                                <td class="center text-warning"> <?php echo(date('Y-m-d' , $v['comp_regis_date']));?> </td>
                                <td class="center"> <?php echo(RGX\misc::cutstr($v['comp_tags'], 25));?> </td>
                                <td class="center">
                                    <a href="<?php echo(RGX\router::url('@%s-add-id-%d' , $_MODULE , $v['comp_id'])); ?>" class="btn btn-success btn-xs radius-small" title="查看">查看</a>
                                </td>
